def process_submission(submissions, bans, username, language, points, number_of_submissions):
...
while True:
    ...
    if len(tokens) == 3:
        ...
        points = int(points)
        process_submission(submissions, bans, username, language, points, number_of_submissions)
    elif len(tokens) == 2:
